...
<html lang="en">
    <head>
      ...
      <title>Affichage de statistiques</title>
...
$query = " select semaine , count(id_creneau) nombre_RDV from creneauxlibre group by semaine ";
  try {
                                            ...
                                            <div class="tab-pane fade in active" id="indexe">
                                                ...
                                                <div class="panel panel-primary">
                                                    <div class="panel-heading">
                                                        <i class="pe-7s-next-2"></i> statistiques
                                                    </div>
                                                    <div class="panel-body">
