...
if(isset($_POST['cocher'])){
    $stmt1 = $bdd->prepare("update professeur set nom = ? , prenom=? where cin =? ");
    $stmt1->execute([$_POST['nom'],$_POST['prenom'],$_POST['cin']]);
    
    
    echo "<script>alert('Le changemement est reussit');</script>";
    
    header("location:http://localhost/pfa/eclipse_work_space/pfa_eclipse/adminpages/modifier_prof.php");
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <div id="login">
                                         <h1>modifier le  compte encadrant </h1>
                                            <form  method="post" action="">
                                            <div class="form-group">cne <input class="form-control" type="text" name="cin" value="<?php echo $row['cin'];?>"/></div>
