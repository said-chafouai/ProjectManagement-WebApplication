...
if(isset($_POST['cocher'])){
        $stmt1 = $bdd->prepare("update etudiant  set nom = ? , prenom=? where cne =? ");
        $stmt1->execute([$_POST['nom'],$_POST['prenom'],$_POST['cne']]);
        

        echo "<script>alert('Le changemement est reussit');</script>";

        header("location:http://localhost:82/pfa/eclipse_work_space/pfa_eclipse/adminpages/modifier_etudiant.php");
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <div id="login">
                                         <h1>modifier le  compte etudiant </h1>
                                            <form  method="post" action="">
                                            <div class="form-group">cne <input class="form-control" type="text" name="cne" value="<?php echo $row['cne'];?>"/></div>
                                            <div class="form-group">Nom <input class="form-control" type="text" name="nom" value="<?php echo $row['nom'];?>"/> </div>
                                            <div class="form-group">Prenom <input class="form-control" type="text" name="prenom" value="<?php echo $row['prenom'];?>"/></div>
