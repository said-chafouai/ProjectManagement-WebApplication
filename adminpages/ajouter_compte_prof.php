...
if (isset ($_POST['valider']))
{
    ...
    $sql = "INSERT INTO professeur(cin,nom,prenom) VALUES('$cin','$nom','$prenom')";
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <div id="login">
                                         <h1>l'ajout d'un compte professeur </h1>
                                            ...
                                            <div class="form-group">cin <input class="form-control" type="text" name="cin"/></div>
                                            <div class="form-group">Nom <input class="form-control" type="text" name="nom"/> </div>
                                            <div class="form-group">Prenom <input class="form-control" type="text" name="prenom"/></div>
                                                  
                                                <input class="btn btn-success" type="submit" name="valider" value="OK"/>
                                            </form>
