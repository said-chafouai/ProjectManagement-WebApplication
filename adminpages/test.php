...
$admin=$_SESSION['admin'];
   ...
   /* $cne1=$_POST['cne1'];
    ...
    $sql = "update  binomes set id_sujet=$sujet where cne1=$binomes[$i]";
...
$query = "SELECT binomes.cne1,binomes.cne2,sujet.intitule_sujet from binomes,sujet where binomes.id_sujet=sujet.id_sujet ;";
  try {
                                            ...
                                            <div class="tab-pane fade in active" id="indexe">
                                                ...
                                                <div class="panel panel-primary">
                                                    <div class="panel-heading">
                                                        <i class="pe-7s-next-2"></i> les projets apres tirage
                                                    </div>
                                                    <div class="panel-body">
...
?>
		<tr>
			<td><?php echo $row['cne1']; ?></td>
			<td><?php echo $row['cne2']; ?></td>
