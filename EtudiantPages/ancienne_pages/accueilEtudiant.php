...
<head>
    ...
    <!-- Bootstrap core CSS     -->
    <link href="../CSS/dashbord_files/assets/css/bootstrap.min.css" rel="stylesheet" />

    <!-- Animation library for notifications   -->
    <link href="../CSS/dashbord_files/assets/css/animate.min.css" rel="stylesheet"/>

    <!--  Light Bootstrap Table core CSS    -->
    <link href="../CSS/dashbord_files/assets/css/light-bootstrap-dashboard.css?v=1.4.0" rel="stylesheet"/>


    <!--  CSS for Demo Purpose, don't include it in your project     -->
    <link href="../CSS/dashbord_files/assets/css/demo.css" rel="stylesheet" />


    <!--     Fonts and icons     -->
    <link href="../CSS/dashbord_files/assets/css/pe-icon-7-stroke.css" rel="stylesheet" />
...
<div class="wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="icons.html">
                        ...
                        <p>Annuler rendez_vous</p>
                    </a>
                </li>
                <li>
                    <a href="maps.html" disabled>
    ...
    <!--   Core JS Files   -->
    <script src="../CSS/dashbord_files/assets/js/jquery.3.2.1.min.js" type="text/javascript"></script>
	<script src="../CSS/dashbord_files/assets/js/bootstrap.min.js" type="text/javascript"></script>

	<!--  Charts Plugin -->
	<script src="../CSS/dashbord_files/assets/js/chartist.min.js"></script>

    <!--  Notifications Plugin    -->
    <script src="../CSS/dashbord_files/assets/js/bootstrap-notify.js"></script>

    <!-- Light Bootstrap Table Core javascript and methods for Demo purpose -->
	<script src="../CSS/dashbord_files/assets/js/light-bootstrap-dashboard.js?v=1.4.0"></script>

	<!-- Light Bootstrap Table DEMO methods, don't include it in your project! -->
	<script src="../CSS/dashbord_files/assets/js/demo.js"></script>
	</script>
